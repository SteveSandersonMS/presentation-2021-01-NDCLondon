...
namespace Microsoft.AspNetCore.Components
{
    ...
    public abstract class ErrorBoundaryAwareComponentBase : IComponent, IHandleEvent, IHandleAfterRender
    {
        ...
        /// </summary>
        public ErrorBoundaryAwareComponentBase()
        {
            _renderFragment = builder =>
            {
                ...
                else
                {
                    ...
                    {
                        // Roll back the output, because partial trees are dangerous
                        builder.Clear();
                        ErrorBoundary.NotifyException(ex);
                    }
                }
            };
        }
